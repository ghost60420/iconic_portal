...
from marketing.services.tiktok import (
    fetch_tiktok_content,
    fetch_tiktok_metrics,
    fetch_tiktok_account_metrics,
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        accounts = SocialAccount.objects.filter(is_active=True, platform="tiktok")
        ...
        for acct in accounts:
            try:
                ...
                content_rows = fetch_tiktok_content(
                    access_token=token,
