...
class QuickCostingTests(TestCase):
    def test_calculation_summary(self):
        ...
        self.assertEqual(summary["total_cost"], Decimal("1000.00"))
        self.assertEqual(summary["cost_per_piece"], Decimal("10.00"))
        self.assertEqual(summary["revenue"], Decimal("1500.00"))
        self.assertEqual(summary["profit_per_piece"], Decimal("5.00"))
        self.assertEqual(summary["total_profit"], Decimal("500.00"))
        self.assertEqual(summary["profit_margin_percent"], Decimal("33.33333333333333333333333333"))
    ...
    def test_quick_costing_create_detail_and_list(self):
        ...
        self.assertContains(detail_response, "500.00")
