...
def build_ceo_executive_context():
    ...
    return {
        ...
        "legacy_test_records": workflow_integrity_metrics["legacy_test_records"],
        "last_integrity_audit_time": workflow_integrity_metrics["last_audit_time"],
        "crm_integrity_status": {
            "workflow_errors": workflow_integrity_metrics["workflow_errors"],
            "broken_opportunities": workflow_integrity_metrics["broken_opportunities"],
            "broken_production_links": workflow_integrity_metrics["broken_production_links"],
            "broken_invoice_links": workflow_integrity_metrics["broken_invoice_links"],
            "legacy_test_records": workflow_integrity_metrics["legacy_test_records"],
            "workflow_errors_health": workflow_integrity_metrics["workflow_errors_health"],
            "broken_opportunities_health": workflow_integrity_metrics["broken_opportunities_health"],
            "broken_production_links_health": workflow_integrity_metrics["broken_production_links_health"],
            "broken_invoice_links_health": workflow_integrity_metrics["broken_invoice_links_health"],
            "legacy_test_records_health": workflow_integrity_metrics["legacy_test_records_health"],
            "last_audit_time": workflow_integrity_metrics["last_audit_time"],
        },
