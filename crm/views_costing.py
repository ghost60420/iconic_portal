...
def _quick_costing_calc(quick_costing):
    ...
    calc = {
        ...
        "product_production_cost_total": summary["product_production_cost_total"],
        "product_production_cost_per_piece": summary["product_production_cost_per_piece"],
    ...
    calc["display"] = {
        ...
        "sales_value": _format_quick_decimal(calc["sales_value"]),
        "sales_value_pair": money_pair(calc["sales_value"]),
        "sales_value_lines": money_lines(calc["sales_value"]),
        "net_revenue": _format_quick_decimal(calc["net_revenue"]),
        "net_revenue_pair": money_pair(calc["net_revenue"]),
        "net_revenue_lines": money_lines(calc["net_revenue"]),
        "product_production_cost_total": _format_quick_decimal(calc["product_production_cost_total"]),
        "product_production_cost_total_pair": money_pair(calc["product_production_cost_total"]),
        "product_production_cost_total_lines": money_lines(calc["product_production_cost_total"]),
        "product_production_cost_per_piece_pair": money_pair(calc["product_production_cost_per_piece"]),
...
def quick_costing_export_excel(request, pk):
    ...
    try:
        ...
        rows.extend([
            ...
            ("Sales Value", calc["display"]["sales_value_pair"]),
            ("Less Shipping Cost", calc["display"]["shipping_cost_total_pair"]),
            ("Less Other Order Expenses", calc["display"]["other_expenses_total_pair"]),
            ("Net Revenue", calc["display"]["net_revenue_pair"]),
...
def quick_costing_export_pdf(request, pk):
    ...
    try:
        ...
        rows = cost_rows + [
            ...
            ("Sales Value", calc["display"]["selling_price_per_piece_pair"], calc["display"]["sales_value_pair"]),
            ("Less Shipping Cost", calc["display"]["shipping_cost_per_piece_pair"], calc["display"]["shipping_cost_total_pair"]),
            ("Less Other Order Expenses", calc["display"]["other_expenses_per_piece_pair"], calc["display"]["other_expenses_total_pair"]),
            ("Net Revenue", "", calc["display"]["net_revenue_pair"]),
